...
// WebDAV 文件定义：每个配置类别独立文件，互不干扰
    const WEBDAV_FILES = {
        keywords: 'zhihu_keywords.json',
        blockedUsers: 'zhihu_blocked_users.json',
        settings: 'zhihu_settings.json'
    };
    ...
    function getLocalDataByFile() {
        return {
            ...
            blockedUsers: { data: [...blockedUsers], lastModified: Date.now() },
