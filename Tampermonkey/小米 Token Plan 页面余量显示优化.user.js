...
(function() {
    ...
    function injectCalculationModule(container, usageSpan) {
        ...
        function updateCreditsInfo() {
            ...
            // 剩余 token = 剩余 credits / credits_per_token
            const tokensForInputCached = Math.floor(remaining / rules.input_cached);
            const tokensForInputUncached = Math.floor(remaining / rules.input_uncached);
            const tokensForOutput = Math.floor(remaining / rules.output);
